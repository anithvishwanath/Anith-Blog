...
So, yes, I feel deeply. I sometimes am ashamed of having such an open heart which always gives and gives because it has always led me to disappointments from external sources. However, all of that is only because of my own perspective—because I, or rather my ego, expects something proportional in return (hard not to, honestly). So it is my own fault. I need to manage my expectations.
...
Stoicism reminds us that while we cannot always control what happens to us, we can control how we respond. While being a Stoic and also feeling emotions might seem like an apparent contradiction, it allows one to navigate life fully with both heart and wisdom.